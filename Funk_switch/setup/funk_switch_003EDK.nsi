...
Section "MainSection" SEC01
  ...
  File "${BASE_DIR}\FUNK_Switch-Beschreibung.docx"
SectionEnd

Section -AdditionalIcons
  CreateDirectory "$SMPROGRAMS\Honeywell\${PRODUCT_NAME}"
  CreateShortCut "$SMPROGRAMS\Honeywell\${PRODUCT_NAME}\FUNK_Switch-Beschreibung.lnk" "$INSTDIR\FUNK_Switch-Beschreibung.docx"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\funk_switch.cab"
...
Section Uninstall
  Delete "$INSTDIR\FUNK_Switch-Beschreibung.docx"
  Delete "$INSTDIR\uninst.exe"
  Delete "$INSTDIR\funk_switch.cab"
  Delete "$INSTDIR\readme.txt"
  Delete "$INSTDIR\HSM EULA.txt"

  Delete "$SMPROGRAMS\Honeywell\${PRODUCT_NAME}\FUNK_Switch-Beschreibung.lnk"
