...
namespace Funk_switch
{
    public class connector:IDisposable
    {
        ...
        void doSwitch()
        {
            ...
            else if (_wifi.getCurrentProfile().sProfileLabel == _profiles[1])
            {
                ...
                if (network._getConnected() == false)
                {
                    ...
                    //switch back
                    _wifi.setProfile(_profiles[1]); //enable second profile
                }
                else
                {
        ...
        void myWorkerThread()
        {
            ...
            {
                OnConnectedMessage("myWorkerThread ThreadAbortException: " + ex.Message);
                ;
            }
            catch (Exception ex)
            {
        ...
        void connectWatchThread()
        {
                ...
                do
                {
                    ...
                    switch (indx)
                    {
                        ...
                        case EventWaitHandle.WAIT_TIMEOUT:
                            ...
                            bRadioPower = _wifi.getRadioEnabled();
                            if (!bRadioPower){
            ...
            {
                OnConnectedMessage("connectWatchThread ThreadAbortException: " + ex.Message);
            }
            catch (Exception ex)
            {
        ...
        void timerThread()
        {
            ...
            {
                OnConnectedMessage("timerThread ThreadAbortException: " + ex.Message);
            }
            catch (Exception ex)
            {
